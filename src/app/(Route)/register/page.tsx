// To inform next js, this is a client component for using state
"use client";
...
import { useRouter } from "next/navigation"; // NEXT.js 13 changes the package for useRouter.
...
export default function Register() {
  ...
  const [error, setErrors] = useState<registerType>({});
